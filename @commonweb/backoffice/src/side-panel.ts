...
@WebComponent({
    ...
    style: `
        ...
        .error {
            background-color: #fc1515; /* Black background color */
        }

        .success {
            background-color: #36be38; /* Black background color */
        }
...
export class SnackbarComponent extends HTMLElement {
    @Attribute("type")
    public type(type: "success" | "error") {
        this.shadowRoot.querySelector("#snackbar").classList.add(type)
    }
